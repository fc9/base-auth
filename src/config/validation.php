...
return [
    ...
    'rules' => [
        ...
        'gender' => '',
        'hour' => '',
        'indicator_check' => 'bail|required|min:4|max:16|string|regex:[0-9a-zA-Z._]+|exists:user,username',
        'indicator_register' => 'bail|required|min:4|max:16|string|regex:\'/^(?=.{4,16}$)(?![_.])(?!.*[_.]{2})[a-zA-Z0-9._]+(?<![_.])$/\'|exists:user,username',
        ...
        'username' => 'bail|required|min:4|max:16|string|regex:[0-9a-zA-Z._]+|exists:user,username',
        'username_login' => 'bail|required|min:4|max:16|string|regex:[0-9a-zA-Z._]+|exists:user,username',
        'username_register' => 'bail|required|min:4|max:16|string|regex:\'/^(?=.{4,16}$)(?![_.])(?!.*[_.]{2})[a-zA-Z0-9._]+(?<![_.])$/\'|unique:user,username',
        'year' => '',
        'zip_code' => 'max:16',
    ],
